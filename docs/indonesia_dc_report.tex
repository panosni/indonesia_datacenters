...
\begin{itemize}[leftmargin=*]
    ...
    \item The baseline annual fiscal cost (revenue foregone) is \textbf{IDR~18.0~trillion} cumulative (0.007\% of GDP). Under a full expansion to 3,000~MW (Scenario~B), the cumulative fiscal cost rises to \textbf{IDR~77.1~trillion} (0.030\% of GDP); with universal VAT/duty exemptions added (Combined B), it reaches \textbf{IDR~93.3~trillion} (0.055\% of GDP).
\end{itemize}
...
VAT / Import Duty          & 0.2  & \\
\midrule
\textbf{Total}             & \textbf{18.0} & \textbf{0.007\%} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Baseline                 & 526   & 76.1  & 15.7 & 2.2 & 0.2  & 18.0 \\
...
\midrule
Baseline cumulative fiscal cost               & IDR 18.0T (0.007\% GDP/yr) \\
...
\begin{enumerate}[leftmargin=*]
    ...
    \item The tax holiday regime is a \textbf{significant driver} of investment: historical data shows an 18.5x investment-to-incentive leverage ratio. The baseline annual fiscal cost is just \textbf{0.007\% of GDP}; even the most expansive scenario (Combined B + VAT) reaches only \textbf{0.055\% of GDP}.
